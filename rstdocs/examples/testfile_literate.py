...
# :Beware: as the docstring is not parsed as separate unit but as part of the
...
# reffered to the text part of the literate source::
...
# 
# The factorial of neagive values is not defined:
#       
#       >>> factorial(-1)
#       Traceback (most recent call last):
#           ...
...
# --------------
# 
# The script is tested by calling ``pylit --doctest testfile_literate``.
# 
# This is especially handy for scripts that should performe some default
